...
<body>    
    <div id="sticky" style="font:black; border:1px; border-color: #3C5087; background-color: #C3E7FA; width: 100px;"  >
	<ul>
	...
	<div class="recent">
	 ...
	 <c:choose>
	    ...
	    <c:otherwise>
           <a  href='javascript:fn_show_previous_goods();'> 이전 </a>   <span id="cur_goods_num">1</span>/${quickGoodsListNum}  <a href='javascript:fn_show_next_goods();'> 다음 </a> 
       </c:otherwise>
       </c:choose>
    </div>
</div>
