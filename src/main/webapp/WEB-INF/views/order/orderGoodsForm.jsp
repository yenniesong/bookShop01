...
<form  name="form_order">	
	...
	<DIV class="detail_table">
		...
		<table class="table table-hover" style="font-size: 13px">
			<tbody>
				<tr class="dot_line">
					<td class="table-primary">배송방법</td>
					<td>
				...
				<tr class="dot_line">
					<td class="table-primary">배송지 선택</td>
				...
				<tr class="dot_line">
					<td class="table-primary">받으실 분</td>
				...
				<tr class="dot_line">
					<td class="table-primary">휴대폰번호</td>
				...
				<tr class="dot_line">
					<td class="table-primary">유선전화(선택)</td>
				...
				<tr class="dot_line">
					<td class="table-primary">배송 메시지</td>
					<td>
				...
				<tr class="dot_line">
					<td class="table-primary">선물 포장</td>
			...
			<table>
				<tbody align=left>
				   ...
				   <tr>
				    ...
				    <button class="btn btn-primary btn-sm" name="btn_process_pay_order" type="button" onClick="fn_process_pay_order()">pay</button>
				    </td>
				   </tr>
				</tbody>
				</table>
