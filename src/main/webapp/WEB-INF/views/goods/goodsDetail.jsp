...
<body>
	...
	<div id="detail_table">
		...
		<ul>
			<li><a class="buy" href="javascript:fn_order_each_goods('${goods.goods_id }','${goods.goods_title }','${goods.goods_sales_price}','${goods.goods_fileName}');">buy </a></li>
			<li><a class="cart" href="javascript:add_cart('${goods.goods_id }')">cart</a></li>
			
			<li><a class="wish" href="#">wishlist</a></li>
		</ul>
	</div>
	<div class="clear"></div>
	<!-- 내용 들어 가는 곳 -->
	...
	<div id="layer" style="visibility: hidden">
		...
		<div id="popup">
			...
			</a> <br /> <font size="3px" id="contents">장바구니에 담았습니다.</font><br>
			<form   action='${contextPath}/cart/myCartList.do'  >				
					<button class="btn btn-primary btn-sm" type="submit" value="go cart" >go cart</button>
			</form>		
		</div>
	</div>	
</body>
