		...
		<table class="table table-hover">
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
					  <input type="button" value="edit" onClick="fn_modify_member_info('member_pw')" />
					</td>
				</tr>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					<td class="fixed_join">GENDER</td>
					<td>
					  <c:choose >
					    <c:when test="${memberInfo.member_gender =='101' }">
					      <input type="radio" name="member_gender" value="102" />
						  female <span style="padding-left:30px"></span>
					   <input type="radio" name="member_gender" value="101" checked />male
					    </c:when>
					    <c:otherwise>
					...
					<td>
					  <input type="button" value="edit" onClick="fn_modify_member_info('member_gender')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">BIRTH</td>
					<td>
					...
					</select>date <span style="padding-left:50px"></span>
					   <c:choose>
					...
					<td>
					  <input type="button" value="edit" onClick="fn_modify_member_info('member_birth')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">TEL</td>
					<td>
					...
					<td>
					  <input type="button" value="edit" onClick="fn_modify_member_info('tel')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">PHONE</td>
					<td>
					...
					<td>
					  <input type="button" value="edit" onClick="fn_modify_member_info('hp')" />
					</td>	
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">EMAIL<br>(e-mail)</td>
					<td>
					...
					<td>
					  <input type="button" value="edit" onClick="fn_modify_member_info('email')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">ADDRESS</td>
					<td>
					...
					<td>
					  <input type="button" value="edit" onClick="fn_modify_member_info('address')" />
					</td>
				</tr>
			</tbody>
		</table>
